    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-[#1a365d] to-[#2d4a7c] text-white py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <Badge className="mb-4 bg-cyan-500 hover:bg-cyan-600">Latest Release</Badge>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-8 text-center">
            <div>
              ...
              <div className="text-cyan-100">User Levels</div>
            </div>
            <div>
              <div className="text-2xl font-bold">500</div>
              <div className="text-cyan-100">History Entries</div>
            </div>
            <div>
              <div className="text-2xl font-bold">16</div>
              <div className="text-cyan-100">Binary Outputs</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <Badge className="mb-4 bg-[#f97316]">Industry First</Badge>
          <h2 className="text-2xl md:text-3xl font-bold mb-4">
            The Dark Display Revolution
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto mb-8">
            Our invertible LCD display provides better readability in direct sunlight. 
            A complete novelty in the industry, designed for real-world field conditions.
          </p>
          <div className="inline-block bg-gray-800 rounded-lg p-8 border border-gray-700">
            ...
            <div className="text-sm text-gray-400 mt-2">Dark Mode Display</div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              'Five times more history storage',
              'Advanced diagnostic capabilities',
              'Better outdoor visibility',
              'Full remote access via bus',
              'Logical signal linking',
            ].map((benefit, index) => (
      ...
      <section className="py-16 bg-[#1a365d] text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">
            Upgrade to Firmware 1.600
          </h2>
          <p className="text-gray-300 mb-8">
            Contact us to learn about upgrading your existing actuators.
          </p>
